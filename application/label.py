...
def save_multi_view_grid_with_labels(joints_data, output_path="pose_grid_labeled.png", frame_indices=None, view_angles=None):
    ...
    # Joint names/descriptions for reference
    joint_names = {
        0: "Pelvis",
        1: "L_Hip",
        2: "R_Hip",
    ...
    # Add margin
    margin = 0.2  # 20% margin to accommodate text labels
    x_range = x_max - x_min
    y_range = y_max - y_min
    z_range = z_max - z_min
    ...
    # Add a legend explaining joint indices
    legend_text = "Joint Index Reference:\n"
    for idx, name in joint_names.items():
        legend_text += f"{idx}: {name}\n"
    
    # Add text box with joint reference
    ...
    print(f"Saved labeled multi-view grid to {output_path}")
    return output_path

# Also modify the save_animated_sequence function to include labels
def save_animated_sequence_with_labels(joints_data, output_dir="pose_frames_labeled", frame_interval=5):
    """Save sequence frames for animation with floor and joint labels"""
...
def main_with_labels():
    parser = argparse.ArgumentParser(description="Visualize IMUPoser predictions with floor and joint labels")
    ...
    parser.add_argument("--grid", type=str, default="pose_grid_labeled.png", help="Path to save multi-view grid")
    parser.add_argument("--frames", type=str, default="pose_frames_labeled", help="Directory to save individual frames")
    ...
    # Save multi-view grid with labels
    frame_indices = [0, 100, 200, 300, 400, 500] if joints.shape[1] >= 500 else None
    save_multi_view_grid_with_labels(joints, args.grid, frame_indices)
    
    # Save frames for animation with labels
    save_animated_sequence_with_labels(joints, args.frames, args.frame_interval)
    
    print("Labeled visualization completed successfully!")
...
def save_animated_sequence(joints_data, output_dir="pose_frames", frame_interval=5):
    ...
    # Categorize connections by body part
    torso_connections = [(0, 1), (1, 4), (4, 7), (7, 10)]
    left_leg_connections = [(1, 3), (3, 6), (6, 9), (9, 12)]  # Fixed to avoid hand connections
    right_leg_connections = [(2, 5), (5, 8), (8, 11), (11, 14)]  # Fixed to avoid hand connections
    left_arm_connections = [(10, 13), (13, 16), (16, 18), (18, 20), (20, 22)]  # Ensure correct shoulder connection
    right_arm_connections = [(10, 14), (14, 17), (17, 19), (19, 21), (21, 23)]  # Ensure correct shoulder connection 
